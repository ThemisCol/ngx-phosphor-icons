export const PhosphorFill = `
<svg xmlns="http://www.w3.org/2000/svg">
<def>
    <svg viewBox="0 0 256 256" fill="currentColor" id="address-book">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="air-traffic-control">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="airplane">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="airplane-in-flight">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="airplane-landing">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="airplane-takeoff">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="airplane-tilt">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="airplay">
        <path d="M182.07,210.79A8,8,0,0,1,176,224H80a8,8,0,0,1-6.07-13.21l48-56a8,8,0,0,1,12.15,0ZM208,40H48A24,24,0,0,0,24,64V176a24,24,0,0,0,24,24H60.26a4,4,0,0,0,3-1.4l46.48-54.22a24,24,0,0,1,36.44,0L192.7,198.6a4,4,0,0,0,3,1.4H208a24,24,0,0,0,24-24V64A24,24,0,0,0,208,40Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="alarm">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="alien">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-bottom">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-bottom-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-center-horizontal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-center-horizontal-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-center-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-center-vertical-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-left-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-right-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-top">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="align-top-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="amazon-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="anchor">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="anchor-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="android-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="angular-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="aperture">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="app-store-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="app-window">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="apple-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="apple-podcasts-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="archive-box">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="archive">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="archive-tray">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="armchair">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-arc-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-arc-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-bend-double-up-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-bend-double-up-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-bend-down-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-bend-down-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-bend-left-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-bend-left-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-bend-right-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-bend-right-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-bend-up-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-bend-up-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-circle-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-circle-down-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-circle-down-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-circle-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-circle-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-circle-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-circle-up-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-circle-up-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-clockwise">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-counter-clockwise">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-down-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-elbow-down-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-elbow-down-right">
        <path d="M213.66,181.66l-48,48A8,8,0,0,1,152,224V184H64a8,8,0,0,1-8-8V32a8,8,0,0,1,16,0V168h80V128a8,8,0,0,1,13.66-5.66l48,48A8,8,0,0,1,213.66,181.66Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-elbow-left-down">
        <path d="M232,64a8,8,0,0,1-8,8H88v80h40a8,8,0,0,1,5.66,13.66l-48,48a8,8,0,0,1-11.32,0l-48-48A8,8,0,0,1,32,152H72V64a8,8,0,0,1,8-8H224A8,8,0,0,1,232,64Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-elbow-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-elbow-left-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-elbow-right-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-elbow-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-elbow-right-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-elbow-up-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-elbow-up-right">
        <path d="M213.66,85.66l-48,48A8,8,0,0,1,152,128V88H72V224a8,8,0,0,1-16,0V80a8,8,0,0,1,8-8h88V32a8,8,0,0,1,13.66-5.66l48,48A8,8,0,0,1,213.66,85.66Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-line-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-line-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-line-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-line-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-lines-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-lines-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-lines-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-lines-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-fat-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-line-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-line-down-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-line-down-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-line-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-line-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-line-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-line-up-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-line-up-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-square-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-square-down-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-square-down-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-square-in">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-square-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-square-out">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-square-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-square-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-square-up-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-square-up-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-u-down-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-u-down-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-u-left-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-u-left-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-u-right-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-u-right-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-u-up-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-u-up-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-up-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrow-up-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-clockwise">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-counter-clockwise">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-down-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-horizontal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-in-cardinal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-in">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-in-line-horizontal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-in-line-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-in-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-left-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-merge">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-out-cardinal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-out">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-out-line-horizontal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-out-line-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-out-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-split">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="arrows-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="article">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="article-medium">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="article-ny-times">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="asterisk">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="asterisk-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="at">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="atom">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="baby">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="backpack">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="backspace">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bag">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bag-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="balloon">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bandaids"><circle cx="128" cy="128" r="12" />
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bank">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="barbell">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="barcode">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="barricade">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="baseball-cap">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="baseball">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="basket">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="basketball">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bathtub">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-charging">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-charging-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-empty">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-full">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-high">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-plus-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-vertical-empty">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-vertical-full">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-vertical-high">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-vertical-low">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-vertical-medium">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-warning">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="battery-warning-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="beer-stein">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="behance-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bell">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bell-ringing">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bell-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bell-simple-ringing">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bell-simple-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bell-simple-z">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bell-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bell-z">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bezier-curve">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bicycle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="binoculars">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bird">
        <path d="M236.44,73.34,213.21,57.86A60,60,0,0,0,96,76V93.19L1.75,211A8,8,0,0,0,8,224H112A104.11,104.11,0,0,0,216,120V100.28l20.44-13.62a8,8,0,0,0,0-13.32ZM110.15,141.12l-40,48a8,8,0,0,1-12.3-10.24l40-48a8,8,0,1,1,12.3,10.24ZM164,80a12,12,0,1,1,12-12A12,12,0,0,1,164,80Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="bluetooth-connected">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bluetooth">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bluetooth-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bluetooth-x">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="boat">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bone">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="book-bookmark">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="book">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="book-open">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="book-open-text">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bookmark">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bookmark-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bookmarks">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bookmarks-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="books">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="boot">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bounding-box">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bowl-food">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="brackets-angle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="brackets-curly">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="brackets-round">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="brackets-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="brain">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="brandy">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bridge">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="briefcase">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="briefcase-metal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="broadcast">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="broom">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bug-beetle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bug-droid">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="bug">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="buildings">
    ...
    <svg viewBox="0 0 256 256" id="bus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="butterfly">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cactus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cake">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="calculator">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="calendar-blank">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="calendar-check">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="calendar">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="calendar-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="calendar-x">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="call-bell">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="camera">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="camera-plus">
        <path d="M208,56H180.28L166.65,35.56A8,8,0,0,0,160,32H96a8,8,0,0,0-6.65,3.56L75.71,56H48A24,24,0,0,0,24,80V192a24,24,0,0,0,24,24H208a24,24,0,0,0,24-24V80A24,24,0,0,0,208,56Zm-48,88H136v24a8,8,0,0,1-16,0V144H96a8,8,0,0,1,0-16h24V104a8,8,0,0,1,16,0v24h24a8,8,0,0,1,0,16Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="camera-rotate">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="camera-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="campfire">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="car">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="car-profile">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="car-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cardholder">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cards"><rect x="24" y="72" width="176" height="144" rx="16" />
        <path d="M216,40H64a8,8,0,0,0,0,16H216V176a8,8,0,0,0,16,0V56A16,16,0,0,0,216,40Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-circle-double-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-circle-double-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-circle-double-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-circle-double-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-circle-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-circle-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-circle-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-circle-up-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-circle-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-double-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-double-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-double-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="caret-double-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cassette-tape">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="castle-turret">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cat">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cell-signal-full">
        <path d="M208,40V200a16,16,0,0,1-16,16H32A16,16,0,0,1,20.7,188.68l160-160A16,16,0,0,1,208,40Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="cell-signal-high">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cell-signal-low">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cell-signal-medium">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cell-signal-none">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cell-signal-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cell-signal-x">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="certificate">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chair">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chalkboard">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chalkboard-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chalkboard-teacher">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="champagne">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="charging-station">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chart-bar">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chart-bar-horizontal">
        <path d="M224,112v32a8,8,0,0,1-8,8H48v16h88a8,8,0,0,1,8,8v24a8,8,0,0,1-8,8H48v8a8,8,0,0,1-16,0V40a8,8,0,0,1,16,0v8H168a8,8,0,0,1,8,8V80a8,8,0,0,1-8,8H48v16H216A8,8,0,0,1,224,112Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="chart-donut">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chart-line-down">
        <path d="M232,208a8,8,0,0,1-8,8H32a8,8,0,0,1-8-8V48a8,8,0,0,1,16,0V60.69l56,56,26.34-26.35a8,8,0,0,1,11.32,0L180,136.69l14.34-14.35A8,8,0,0,1,208,128v40a8,8,0,0,1-8,8H160a8,8,0,0,1-5.66-13.66L168.69,148,128,107.31l-26.34,26.35a8,8,0,0,1-11.32,0L40,83.31V200H224A8,8,0,0,1,232,208Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="chart-line">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chart-line-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chart-pie">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chart-pie-slice">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chart-polar">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chart-scatter">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat-centered-dots">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat-centered">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat-centered-text">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat-circle-dots">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat-circle">
        <path d="M232,128A104,104,0,0,1,79.12,219.82L45.07,231.17a16,16,0,0,1-20.24-20.24l11.35-34.05A104,104,0,1,1,232,128Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat-circle-text">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat-dots">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat-teardrop-dots">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat-teardrop">
        <path d="M232,124A100.11,100.11,0,0,1,132,224H47.67A15.69,15.69,0,0,1,32,208.33V124a100,100,0,0,1,200,0Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat-teardrop-text">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chat-text">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chats-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chats">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="chats-teardrop">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="check-circle">
        <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm45.66,85.66-56,56a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L112,148.69l50.34-50.35a8,8,0,0,1,11.32,11.32Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="check-fat">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="check">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="check-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="check-square-offset">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="checks">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="church">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="circle-dashed">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="circle">
        <path d="M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="circle-half">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="circle-half-tilt">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="circle-notch">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="circles-four">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="circles-three">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="circles-three-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="circuitry">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="clipboard">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="clipboard-text">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="clock-afternoon">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="clock-clockwise">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="clock-countdown">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="clock-counter-clockwise">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="clock">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="closed-captioning">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-arrow-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-arrow-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-check">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-fog">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-lightning">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-moon">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-rain">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-slash">
        <path d="M53.92,34.62A8,8,0,1,0,42.08,45.38L81.32,88.55l-.06.12A64,64,0,1,0,72,216h88a87.34,87.34,0,0,0,31.8-5.93l10.28,11.31a8,8,0,1,0,11.84-10.76Z" />
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-snow">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-sun">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-warning">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cloud-x">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="club">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="coat-hanger">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="coda-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="code-block">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="code">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="code-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="codepen-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="codesandbox-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="coffee">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="coin">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="coin-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="coins">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="columns">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="command">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="compass">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="compass-tool">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="computer-tower">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="confetti">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="contactless-payment">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cooking-pot">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="copy">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="copy-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="copyleft">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="copyright">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="corners-in">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="corners-out">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="couch">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cpu">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="credit-card">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="crop">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cross">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="crosshair">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="crosshair-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="crown">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="crown-simple">
        <path d="M247.37,89.15l-37,113.33a8,8,0,0,1-11.71,4.39c-.23-.14-25.8-14.87-70.68-14.87s-70.45,14.73-70.7,14.88a8,8,0,0,1-11.68-4.4L8.62,89.12A12.11,12.11,0,0,1,25.52,74.5l50.19,25,41.92-69.66a12.11,12.11,0,0,1,20.74,0l41.92,69.66,50.21-25a12.1,12.1,0,0,1,16.87,14.66Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="cube">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cube-focus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cube-transparent">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-btc">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-circle-dollar">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-cny">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-dollar">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-dollar-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-eth">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-eur">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-gbp">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-inr">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-jpy">
        <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm62,53.27L145.63,128H160a8,8,0,0,1,0,16H136v16h24a8,8,0,0,1,0,16H136v16a8,8,0,0,1-16,0V176H96a8,8,0,0,1,0-16h24V144H96a8,8,0,0,1,0-16h14.37L66,77.27A8,8,0,0,1,78,66.73l50,57.12,50-57.12a8,8,0,1,1,12,10.54Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-krw">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-kzt">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-ngn">
        <path d="M88,93.63,110.61,120H88Zm80,68.74V136H145.39ZM232,128A104,104,0,1,1,128,24,104.11,104.11,0,0,1,232,128Zm-32,0a8,8,0,0,0-8-8h-8V72a8,8,0,0,0-16,0v48H131.68L86.07,66.79A8,8,0,0,0,72,72v48H64a8,8,0,0,0,0,16h8v48a8,8,0,0,0,16,0V136h36.32l45.61,53.21A8,8,0,0,0,176,192a8,8,0,0,0,8-8V136h8A8,8,0,0,0,200,128Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="currency-rub">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cursor-click">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cursor">
        <path d="M219.31,192a16,16,0,0,1,0,22.63l-4.68,4.68a16,16,0,0,1-22.63,0l-55.25-55.24-21.88,50.34A15.84,15.84,0,0,1,100.26,224l-.78,0a15.82,15.82,0,0,1-14.41-11L32.8,52.92A15.95,15.95,0,0,1,52.92,32.8L213,85.07a16,16,0,0,1,1.41,29.8l-50.34,21.88Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="cursor-text">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="cylinder">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="database">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="desktop">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="desktop-tower">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="detective">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dev-to-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="device-mobile-camera">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="device-mobile">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="device-mobile-speaker">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="device-tablet-camera">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="device-tablet">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="device-tablet-speaker">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="devices">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="diamond">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="diamonds-four">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dice-five">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dice-four">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dice-one">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dice-six">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dice-three">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dice-two">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="disc">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="discord-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="divide">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dna">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dog">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="door">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="door-open">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dot">
        <path d="M128,80a48,48,0,1,0,48,48A48,48,0,0,0,128,80Zm0,60a12,12,0,1,1,12-12A12,12,0,0,1,128,140Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="dot-outline">
        <path d="M156,128a28,28,0,1,1-28-28A28,28,0,0,1,156,128Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="dots-nine">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dots-six">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dots-six-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dots-three-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dots-three-circle-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dots-three">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dots-three-outline">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dots-three-outline-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dots-three-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="download">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="download-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dress">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dribbble-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="drop">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="drop-half-bottom">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="drop-half">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="dropbox-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="ear">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="ear-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="egg-crack">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="egg">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="eject">
        <path d="M224,176v24a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V176a16,16,0,0,1,16-16H208A16,16,0,0,1,224,176ZM48.24,144H207.76a16.18,16.18,0,0,0,14.93-9.76,15.59,15.59,0,0,0-3.1-17.12L145.86,39.61a24.76,24.76,0,0,0-35.72,0L36.41,117.12h0a15.59,15.59,0,0,0-3.1,17.12A16.18,16.18,0,0,0,48.24,144Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="eject-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="elevator">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="engine">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="envelope">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="envelope-open">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="envelope-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="envelope-simple-open">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="equalizer">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="equals">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="eraser">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="escalator-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="escalator-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="exam">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="exclude">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="exclude-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="export">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="eye-closed">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="eye">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="eye-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="eyedropper">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="eyedropper-sample">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="eyeglasses">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="face-mask">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="facebook-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="factory">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="faders">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="faders-horizontal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="fan">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="fast-forward-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="fast-forward">
        <path d="M248,128a15.76,15.76,0,0,1-7.33,13.34L152.48,197.5A15.91,15.91,0,0,1,128,184.16v-37.3L48.48,197.5A15.91,15.91,0,0,1,24,184.16V71.84A15.91,15.91,0,0,1,48.48,58.5L128,109.14V71.84A15.91,15.91,0,0,1,152.48,58.5l88.19,56.16A15.76,15.76,0,0,1,248,128Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="feather">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="figma-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-archive">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-arrow-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-arrow-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-audio">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-cloud">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-code">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-css">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-csv">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-dashed">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-doc">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-html">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-image">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-jpg">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-js">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-jsx">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-lock">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-magnifying-glass">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-minus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-pdf">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-png">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-ppt">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-rs">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-sql">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-svg">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-text">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-ts">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-tsx">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-video">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-vue">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-x">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-xls">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="file-zip">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="files">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="film-reel">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="film-script">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="film-slate">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="film-strip">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="fingerprint">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="fingerprint-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="finn-the-human">
        <path d="M176,140a12,12,0,1,1-12-12A12,12,0,0,1,176,140ZM92,128a12,12,0,1,0,12,12A12,12,0,0,0,92,128ZM240,64v80a72.08,72.08,0,0,1-72,72H88a72.08,72.08,0,0,1-72-72V64a32,32,0,0,1,63-8h98a32,32,0,0,1,63,8Zm-40,72a32,32,0,0,0-32-32H88a32,32,0,0,0-32,32v8a32,32,0,0,0,32,32h80a32,32,0,0,0,32-32Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="fire-extinguisher">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="fire">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="fire-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="first-aid">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="first-aid-kit">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="fish">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="fish-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="flag-banner">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="flag-checkered">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="flag">
        <path d="M224,48V168a8,8,0,0,1-2.76,6c-15.28,13.23-29.89,18-43.82,18-18.91,0-36.57-8.74-53-16.85C97.87,162,74.79,150.61,48,171.77V216a8,8,0,0,1-16,0V48a8,8,0,0,1,2.77-6h0c36-31.18,68.31-15.21,96.79-1.12C159,54.46,182.79,66.2,210.76,42A8,8,0,0,1,224,48Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="flag-pennant">
        <path d="M248,104a8,8,0,0,1-5.37,7.56L64,173.69V216a8,8,0,0,1-16,0V40a8,8,0,0,1,10.63-7.56l184,64A8,8,0,0,1,248,104Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="flame">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="flashlight">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="flask">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="floppy-disk-back">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="floppy-disk">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="flow-arrow">
        <path d="M245.66,85.66l-32,32a8,8,0,0,1-11.32-11.32L220.69,88H192c-1.66,0-41.35.77-48.11,41.31C139,158.6,121.75,172,108.13,178a71.12,71.12,0,0,1-27.49,6H79a32,32,0,1,1,0-16h1.33c1.62,0,40.77.81,47.79-41.32C132.82,98.44,150,85,163.65,78.73A74.49,74.49,0,0,1,192,72h28.69L202.34,53.66a8,8,0,0,1,11.32-11.32l32,32A8,8,0,0,1,245.66,85.66Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="flower">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="flower-lotus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="flower-tulip">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="flying-saucer">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-dashed">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-lock">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-minus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-notch">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-notch-minus">
        <path d="M216,72H130.66L102.92,51.2A16,16,0,0,0,93.34,48H40A16,16,0,0,0,24,64V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V88A16,16,0,0,0,216,72ZM40,96V64H93.34l21.33,16L93.33,96Zm112,64H104a8,8,0,0,1,0-16h48a8,8,0,0,1,0,16Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-notch-open">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-notch-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-open">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-simple-dashed">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-simple-lock">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-simple-minus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-simple-plus">
        <path d="M216,72H130.67L102.92,51.2A16,16,0,0,0,93.34,48H40A16,16,0,0,0,24,64V200a16,16,0,0,0,16,16H216.89A15.13,15.13,0,0,0,232,200.89V88A16,16,0,0,0,216,72Zm-64,80H136v16a8,8,0,0,1-16,0V152H104a8,8,0,0,1,0-16h16V120a8,8,0,0,1,16,0v16h16a8,8,0,0,1,0,16Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-simple-star">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-simple-user">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-star">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folder-user">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="folders">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="football">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="footprints">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="fork-knife">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="frame-corners">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="framer-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="function">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="funnel">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="funnel-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="game-controller">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="garage">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gas-can">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gas-pump">
        <path d="M241,69.66,221.66,50.34a8,8,0,0,0-11.32,11.32L229.66,81A8,8,0,0,1,232,86.63V168a8,8,0,0,1-16,0V128a24,24,0,0,0-24-24H176V56a24,24,0,0,0-24-24H72A24,24,0,0,0,48,56V208H32a8,8,0,0,0,0,16H192a8,8,0,0,0,0-16H176V120h16a8,8,0,0,1,8,8v40a24,24,0,0,0,48,0V86.63A23.85,23.85,0,0,0,241,69.66ZM144,120H80a8,8,0,0,1,0-16h64a8,8,0,0,1,0,16Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="gauge">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gavel">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gear">
    ...
    <svg viewBox="0 0 256 256" id="gear-fine">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gear-six">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gender-female">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gender-intersex">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gender-male">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gender-neuter">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gender-nonbinary">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gender-transgender">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="ghost">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gif">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gift">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="git-branch">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="git-commit">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="git-diff">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="git-fork">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="git-merge">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="git-pull-request">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="github-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gitlab-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gitlab-logo-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="globe">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="globe-hemisphere-east">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="globe-hemisphere-west">
        <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm88,104a87.62,87.62,0,0,1-6.4,32.94l-44.7-27.49a15.92,15.92,0,0,0-6.24-2.23l-22.82-3.08a16.11,16.11,0,0,0-16,7.86h-8.72l-3.8-7.86a15.91,15.91,0,0,0-11-8.67l-8-1.73L96.14,104h16.71a16.06,16.06,0,0,0,7.73-2l12.25-6.76a16.62,16.62,0,0,0,3-2.14l26.91-24.34A15.93,15.93,0,0,0,166,49.1l-.36-.65A88.11,88.11,0,0,1,216,128ZM40,128a87.53,87.53,0,0,1,8.54-37.8l11.34,30.27a16,16,0,0,0,11.62,10l21.43,4.61L96.74,143a16.09,16.09,0,0,0,14.4,9h1.48l-7.23,16.23a16,16,0,0,0,2.86,17.37l.14.14L128,205.94l-1.94,10A88.11,88.11,0,0,1,40,128Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="globe-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="globe-stand">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="goggles">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="goodreads-logo">
        <path d="M160,104v8a32,32,0,0,1-64,0v-8a32,32,0,0,1,64,0Zm72,24A104,104,0,1,1,128,24,104.11,104.11,0,0,1,232,128ZM176,64a8,8,0,0,0-16,0v4.26A48,48,0,0,0,80,104v8a48,48,0,0,0,80,35.74V160a32,32,0,0,1-57.6,19.2,8,8,0,1,0-12.8,9.6A48,48,0,0,0,176,160Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="google-cardboard-logo">
        <path d="M224,48H32A16,16,0,0,0,16,64V192a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,203.31l21.17-21.17a4,4,0,0,1,5.66,0L152,203.32A15.89,15.89,0,0,0,163.31,208H224a16,16,0,0,0,16-16V64A16,16,0,0,0,224,48ZM80,152a24,24,0,1,1,24-24A24,24,0,0,1,80,152Zm96,0a24,24,0,1,1,24-24A24,24,0,0,1,176,152Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="google-chrome-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="google-drive-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="google-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="google-photos-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="google-play-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="google-podcasts-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="gradient">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="graduation-cap">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="grains">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="grains-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="graph">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="grid-four">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="grid-nine">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="guitar">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hamburger">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hammer">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-coins">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-eye">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-fist">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-grabbing">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-heart">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-palm">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-pointing">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-soap">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-swipe-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-swipe-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-tap">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hand-waving">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="handbag">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="handbag-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hands-clapping">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hands-praying">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="handshake">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hard-drive">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hard-drives">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hash-straight">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="headlights">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="headphones">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="headset">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="heart-break">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="heart">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="heart-half">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="heart-straight-break">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="heart-straight">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="heartbeat">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hexagon">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="high-heel">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="highlighter-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hoodie">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="horse">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hourglass">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hourglass-high">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hourglass-low">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hourglass-medium">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hourglass-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hourglass-simple-high">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="hourglass-simple-low">
        <path d="M211.18,196.56,139.57,128l71.61-68.56a1.59,1.59,0,0,1,.13-.13A16,16,0,0,0,200,32H56A16,16,0,0,0,44.69,59.31a1.59,1.59,0,0,1,.13.13L116.43,128,44.82,196.56a1.59,1.59,0,0,1-.13.13A16,16,0,0,0,56,224H200a16,16,0,0,0,11.32-27.31A1.59,1.59,0,0,1,211.18,196.56ZM56,48h0v0ZM158.21,168H97.79L128,139.08ZM200,48l-72,68.92L56,48Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="hourglass-simple-medium">
        <path d="M211.18,196.56,139.57,128l71.61-68.56a1.59,1.59,0,0,1,.13-.13A16,16,0,0,0,200,32H56A16,16,0,0,0,44.69,59.31a1.59,1.59,0,0,1,.13.13L116.43,128,44.82,196.56a1.59,1.59,0,0,1-.13.13A16,16,0,0,0,56,224H200a16,16,0,0,0,11.32-27.31A1.59,1.59,0,0,1,211.18,196.56ZM56,48h0v0Zm144,0L174.92,72H81.08L56,48ZM56,208l64-61.26V168a8,8,0,0,0,16,0V146.74L200,208Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="house">
        <path d="M224,115.55V208a16,16,0,0,1-16,16H168a16,16,0,0,1-16-16V168a8,8,0,0,0-8-8H112a8,8,0,0,0-8,8v40a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V115.55a16,16,0,0,1,5.17-11.78l80-75.48.11-.11a16,16,0,0,1,21.53,0,1.14,1.14,0,0,0,.11.11l80,75.48A16,16,0,0,1,224,115.55Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="house-line">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="house-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="ice-cream">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="identification-badge">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="identification-card">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="image">
        <path d="M216,40H40A16,16,0,0,0,24,56V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40ZM156,88a12,12,0,1,1-12,12A12,12,0,0,1,156,88ZM40,200V172l52-52,80,80Zm176,0H194.63l-36-36,20-20L216,181.38V200Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="image-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="images">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="images-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="infinity">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="info">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="instagram-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="intersect">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="intersect-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="intersect-three">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="jeep">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="kanban">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="key">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="key-return">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="keyboard">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="keyhole">
        <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm22.58-80,12.56,31.55A12,12,0,0,1,152,184H104a12,12,0,0,1-11.14-16.44L105.42,136a36,36,0,1,1,45.16,0Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="knife">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="ladder">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="ladder-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lamp">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="laptop">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="layout">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="leaf">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lifebuoy">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lightbulb-filament">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lightbulb">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lighthouse">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lightning-a">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lightning">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lightning-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="line-segment">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="line-segments">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="link-break">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="link">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="link-simple-break">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="link-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="link-simple-horizontal-break">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="link-simple-horizontal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="linkedin-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="linux-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="list-bullets">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="list-checks">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="list-dashes">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="list">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="list-magnifying-glass">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="list-numbers">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="list-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lock">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lock-key">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lock-key-open">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lock-laminated">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lock-laminated-open">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lock-open">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lock-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lock-simple-open">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="lockers">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="magic-wand">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="magnet">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="magnet-straight">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="magnifying-glass">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="magnifying-glass-minus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="magnifying-glass-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="map-pin">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="map-pin-line">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="map-trifold">
        <path d="M228.92,49.69a8,8,0,0,0-6.86-1.45L160.93,63.52,99.58,32.84a8,8,0,0,0-5.52-.6l-64,16A8,8,0,0,0,24,56V200a8,8,0,0,0,9.94,7.76l61.13-15.28,61.35,30.68A8.15,8.15,0,0,0,160,224a8,8,0,0,0,1.94-.24l64-16A8,8,0,0,0,232,200V56A8,8,0,0,0,228.92,49.69ZM96,176a8,8,0,0,0-1.94.24L40,189.75V62.25L95.07,48.48l.93.46Zm120,17.75-55.07,13.77-.93-.46V80a8,8,0,0,0,1.94-.23L216,66.25Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="marker-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="martini">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="mask-happy">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="mask-sad">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="math-operations">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="medal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="medal-military">
        <path d="M207,32H49A17,17,0,0,0,32,49V98.21a17,17,0,0,0,10,15.47l62.6,28.45a48,48,0,1,0,46.88,0L214,113.68a17,17,0,0,0,10-15.47V49A17,17,0,0,0,207,32ZM96,48h64v72.67l-32,14.54L96,120.67Zm32,168a32,32,0,1,1,32-32A32,32,0,0,1,128,216Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="medium-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="megaphone">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="megaphone-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="messenger-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="meta-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="metronome">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="microphone">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="microphone-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="microphone-stage">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="microsoft-excel-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="microsoft-outlook-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="microsoft-powerpoint-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="microsoft-teams-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="microsoft-word-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="minus-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="money">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="monitor"><rect x="24" y="40" width="208" height="160" rx="24" />
        <path d="M160,216H96a8,8,0,0,0,0,16h64a8,8,0,0,0,0-16Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="monitor-play">
        <path d="M168,224a8,8,0,0,1-8,8H96a8,8,0,0,1,0-16h64A8,8,0,0,1,168,224ZM232,64V176a24,24,0,0,1-24,24H48a24,24,0,0,1-24-24V64A24,24,0,0,1,48,40H208A24,24,0,0,1,232,64Zm-68,56a8,8,0,0,0-3.71-6.75l-44-28A8,8,0,0,0,104,92v56a8,8,0,0,0,12.29,6.75l44-28A8,8,0,0,0,164,120Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="moon">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="moon-stars">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="moped">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="moped-front">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="mosque">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="motorcycle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="mountains">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="mouse">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="mouse-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="music-note">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="music-note-simple">
        <path d="M210.3,56.34l-80-24A8,8,0,0,0,120,40V148.26A48,48,0,1,0,136,184V50.75l69.7,20.91a8,8,0,1,0,4.6-15.32Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="music-notes">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="music-notes-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="music-notes-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="navigation-arrow">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="needle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="newspaper-clipping">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="newspaper">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="notches">
        <path d="M200,40V192a8,8,0,0,1-8,8H40a8,8,0,0,1-5.66-13.66l152-152A8,8,0,0,1,200,40Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="note-blank">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="note">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="note-pencil">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="notebook">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="notepad">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="notification">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="notion-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-circle-eight">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-circle-five">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-circle-four">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-circle-nine">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-circle-one">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-circle-seven">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-circle-six">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-circle-three">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-circle-two">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-circle-zero">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-eight">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-five">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-four">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-nine">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-one">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-seven">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-six">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-square-eight">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-square-five">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-square-four">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-square-nine">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-square-one">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-square-seven">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-square-six">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-square-three">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-square-two">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-square-zero">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-three">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-two">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="number-zero">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="nut">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="ny-times-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="octagon">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="office-chair">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="option">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="orange-slice">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="package">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paint-brush-broad">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paint-brush">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paint-brush-household">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paint-bucket">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paint-roller">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="palette">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pants">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paper-plane">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paper-plane-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paper-plane-tilt">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paperclip">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paperclip-horizontal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="parachute">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paragraph">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="parallelogram">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="park">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="password">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="path">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="patreon-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pause-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pause">
        <path d="M216,48V208a16,16,0,0,1-16,16H160a16,16,0,0,1-16-16V48a16,16,0,0,1,16-16h40A16,16,0,0,1,216,48ZM96,32H56A16,16,0,0,0,40,48V208a16,16,0,0,0,16,16H96a16,16,0,0,0,16-16V48A16,16,0,0,0,96,32Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="paw-print">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="paypal-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="peace">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pen">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pen-nib">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pen-nib-straight">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pencil-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pencil">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pencil-line">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pencil-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pencil-simple-line">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pencil-simple-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pencil-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pentagram">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pepper">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="percent">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="person-arms-spread">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="person">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="person-simple-bike">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="person-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="person-simple-run">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="person-simple-throw">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="person-simple-walk">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="perspective">
        <path d="M224,120H32V77.09A16,16,0,0,1,45.14,61.35l160-29.09A16,16,0,0,1,224,48ZM32,178.91a16,16,0,0,0,13.14,15.74l160,29.09A16.47,16.47,0,0,0,208,224a16,16,0,0,0,16-16V136H32ZM240,120H224v16h16a8,8,0,0,0,0-16ZM16,120a8,8,0,0,0,0,16H32V120Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="phone-call">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="phone-disconnect">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="phone">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="phone-incoming">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="phone-outgoing">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="phone-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="phone-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="phone-x">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="phosphor-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pi">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="piano-keys">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="picture-in-picture">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="piggy-bank">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pill">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pinterest-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pinwheel">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pizza">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="placeholder">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="planet">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="plant">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="play-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="play">
        <path d="M240,128a15.74,15.74,0,0,1-7.6,13.51L88.32,229.65a16,16,0,0,1-16.2.3A15.86,15.86,0,0,1,64,216.13V39.87a15.86,15.86,0,0,1,8.12-13.82,16,16,0,0,1,16.2.3L232.4,114.49A15.74,15.74,0,0,1,240,128Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="play-pause">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="playlist">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="plug-charging">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="plug">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="plugs-connected">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="plugs">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="plus-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="plus-minus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="plus-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="poker-chip">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="police-car">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="polygon">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="popcorn">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="potted-plant">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="power">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="prescription">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="presentation-chart">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="presentation">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="printer">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="prohibit">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="prohibit-inset">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="projector-screen-chart">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="projector-screen">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="pulse">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="push-pin">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="push-pin-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="push-pin-simple-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="push-pin-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="puzzle-piece">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="qr-code"><rect x="40" y="40" width="80" height="80" rx="16" /><rect x="40" y="136" width="80" height="80" rx="16" /><rect x="136" y="40" width="80" height="80" rx="16" />
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="question">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="queue">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="quotes">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="radical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="radio-button">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="radio">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="radioactive">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="rainbow-cloud">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="rainbow">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="read-cv-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="receipt">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="receipt-x">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="record">
        <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Z" /><circle cx="128" cy="128" r="72" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="rectangle"><rect x="24" y="40" width="208" height="176" rx="16" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="recycle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="reddit-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="repeat">
        <path d="M24,128A72.08,72.08,0,0,1,96,56h96V40a8,8,0,0,1,13.66-5.66l24,24a8,8,0,0,1,0,11.32l-24,24A8,8,0,0,1,192,88V72H96a56.06,56.06,0,0,0-56,56,8,8,0,0,1-16,0Zm200-8a8,8,0,0,0-8,8,56.06,56.06,0,0,1-56,56H64V168a8,8,0,0,0-13.66-5.66l-24,24a8,8,0,0,0,0,11.32l24,24A8,8,0,0,0,64,216V200h96a72.08,72.08,0,0,0,72-72A8,8,0,0,0,224,120Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="repeat-once">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="rewind-circle">
        <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm48,132a8,8,0,0,1-12.59,6.55l-40-28A8,8,0,0,1,120,128v28a8,8,0,0,1-12.59,6.55l-40-28a8,8,0,0,1,0-13.1l40-28A8,8,0,0,1,120,100v28a8,8,0,0,1,3.41-6.55l40-28A8,8,0,0,1,176,100Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="rewind">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="road-horizon">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="robot">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="rocket">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="rocket-launch">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="rows">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="rss">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="rss-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="rug">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="ruler">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="scales">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="scan">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="scissors">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="scooter">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="screencast">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="scribble-loop">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="scroll">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="seal-check">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="seal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="seal-question">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="seal-warning">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="selection-all">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="selection-background">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="selection">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="selection-foreground">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="selection-inverse">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="selection-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="selection-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shapes">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="share-fat">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="share">
        <path d="M229.66,109.66l-48,48A8,8,0,0,1,168,152V112h-3a88,88,0,0,0-85.23,66,8,8,0,0,1-15.5-4A103.94,103.94,0,0,1,165,96h3V56a8,8,0,0,1,13.66-5.66l48,48A8,8,0,0,1,229.66,109.66ZM192,208H40V88a8,8,0,0,0-16,0V208a16,16,0,0,0,16,16H192a8,8,0,0,0,0-16Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="share-network">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shield-check">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shield-checkered">
        <path d="M208,40H48A16,16,0,0,0,32,56v58.77c0,89.62,75.82,119.34,91,124.38a15.44,15.44,0,0,0,10,0c15.2-5.05,91-34.77,91-124.39V56A16,16,0,0,0,208,40ZM48.66,128H128V56h80v58.77a130.51,130.51,0,0,1-.66,13.21H128v96h0C115.26,219.73,55.59,196.26,48.66,128Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="shield-chevron">
        <path d="M208,40H48A16,16,0,0,0,32,56v58.77c0,89.61,75.82,119.34,91,124.39a15.53,15.53,0,0,0,10,0c15.2-5.05,91-34.78,91-124.39V56A16,16,0,0,0,208,40Zm0,74.79c0,17.64-3.36,32.63-8.72,45.34l-66.69-46.68a8,8,0,0,0-9.18,0L56.72,160.13C51.36,147.42,48,132.43,48,114.79V56l160,0Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="shield">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shield-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shield-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shield-star">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shield-warning">
        <path d="M208,40H48A16,16,0,0,0,32,56v58.77c0,89.62,75.82,119.34,91,124.38a15.44,15.44,0,0,0,10,0c15.2-5.05,91-34.77,91-124.39V56A16,16,0,0,0,208,40ZM120,96a8,8,0,0,1,16,0v40a8,8,0,0,1-16,0Zm8,88a12,12,0,1,1,12-12A12,12,0,0,1,128,184Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="shirt-folded">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shooting-star">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shopping-bag">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shopping-bag-open">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shopping-cart">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shopping-cart-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shower">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shrimp">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shuffle-angular">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shuffle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="shuffle-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sidebar">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sidebar-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sigma">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sign-in">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sign-out">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="signature">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="signpost">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sim-card">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="siren">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sketch-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="skip-back-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="skip-back">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="skip-forward-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="skip-forward">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="skull">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="slack-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sliders">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sliders-horizontal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="slideshow">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="smiley-angry">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="smiley-blank">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="smiley">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="smiley-meh">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="smiley-nervous">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="smiley-sad">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="smiley-sticker">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="smiley-wink">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="smiley-x-eyes">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="snapchat-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sneaker">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sneaker-move">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="snowflake">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="soccer-ball">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sort-ascending">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sort-descending">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="soundcloud-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="spade">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sparkle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="speaker-hifi">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="speaker-high">
        <path d="M155.51,24.81a8,8,0,0,0-8.42.88L77.25,80H32A16,16,0,0,0,16,96v64a16,16,0,0,0,16,16H77.25l69.84,54.31A8,8,0,0,0,160,224V32A8,8,0,0,0,155.51,24.81ZM72,160H32V96H72Zm126-58.44a40,40,0,0,1,0,52.88,8,8,0,0,1-12-10.58,24,24,0,0,0,0-31.72,8,8,0,0,1,12-10.58ZM248,128a79.9,79.9,0,0,1-20.37,53.34,8,8,0,0,1-11.92-10.67,64,64,0,0,0,0-85.33,8,8,0,1,1,11.92-10.67A79.83,79.83,0,0,1,248,128Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="speaker-low">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="speaker-none">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="speaker-simple-high">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="speaker-simple-low">
        <path d="M160,32V224a8,8,0,0,1-12.91,6.31L77.25,176H32a16,16,0,0,1-16-16V96A16,16,0,0,1,32,80H77.25l69.84-54.31A8,8,0,0,1,160,32Zm32,64a8,8,0,0,0-8,8v48a8,8,0,0,0,16,0V104A8,8,0,0,0,192,96Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="speaker-simple-none">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="speaker-simple-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="speaker-simple-x">
        <path d="M155.52,24.81a8,8,0,0,0-8.43.88L77.25,80H32A16,16,0,0,0,16,96v64a16,16,0,0,0,16,16H77.25l69.84,54.31A7.94,7.94,0,0,0,152,232a8,8,0,0,0,8-8V32A8,8,0,0,0,155.52,24.81Z" />
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="speaker-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="speaker-x">
        <path d="M155.51,24.81a8,8,0,0,0-8.42.88L77.25,80H32A16,16,0,0,0,16,96v64a16,16,0,0,0,16,16H77.25l69.84,54.31A8,8,0,0,0,160,224V32A8,8,0,0,0,155.51,24.81ZM32,96H72v64H32Z" />
        <path d="M227.31,128l18.35-18.34a8,8,0,0,0-11.32-11.32L216,116.69,197.66,98.34a8,8,0,0,0-11.32,11.32L204.69,128l-18.35,18.34a8,8,0,0,0,11.32,11.32L216,139.31l18.34,18.35a8,8,0,0,0,11.32-11.32Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="spinner">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="spinner-gap">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="spiral">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="split-horizontal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="split-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="spotify-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="square"><rect x="32" y="32" width="192" height="192" rx="16" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="square-half-bottom">
        <path d="M200,40H56A16,16,0,0,0,40,56V200a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V56A16,16,0,0,0,200,40Zm0,16v72H56V56Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="square-half">
        <path d="M200,40H56A16,16,0,0,0,40,56V200a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V56A16,16,0,0,0,200,40ZM56,56h72V200H56Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="square-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="square-split-horizontal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="square-split-vertical">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="squares-four">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="stack">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="stack-overflow-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="stack-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="stairs">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="stamp">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="star-and-crescent">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="star">
        <path d="M234.5,114.38l-45.1,39.36,13.51,58.6a16,16,0,0,1-23.84,17.34l-51.11-31-51,31a16,16,0,0,1-23.84-17.34L66.61,153.8,21.5,114.38a16,16,0,0,1,9.11-28.06l59.46-5.15,23.21-55.36a15.95,15.95,0,0,1,29.44,0h0L166,81.17l59.44,5.15a16,16,0,0,1,9.11,28.06Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="star-four">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="star-half">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="star-of-david">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="steering-wheel">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="steps">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="stethoscope">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sticker">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="stool">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="stop-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="stop">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="storefront">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="strategy">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="stripe-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="student">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="subtitles">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="suitcase">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="suitcase-rolling">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="suitcase-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sun-dim">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sun">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sun-horizon">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sunglasses">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="swap">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="swatches">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="swimming-pool">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="sword">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="synagogue">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="syringe">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="t-shirt">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="table">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tabs">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tag-chevron">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tag">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tag-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="target">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="taxi">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="telegram-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="television">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="television-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tennis-ball">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tent">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="terminal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="terminal-window">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="test-tube">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-a-underline">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-aa">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-align-center">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-align-justify">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-align-left">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-align-right">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-b">
        <path d="M168,156a20,20,0,0,1-20,20H96V136h52A20,20,0,0,1,168,156ZM224,48V208a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V48A16,16,0,0,1,48,32H208A16,16,0,0,1,224,48ZM184,156a36,36,0,0,0-18-31.15A36,36,0,0,0,140,64H88a8,8,0,0,0-8,8V184a8,8,0,0,0,8,8h60A36,36,0,0,0,184,156Zm-24-56a20,20,0,0,0-20-20H96v40h44A20,20,0,0,0,160,100Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-columns">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-h">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-h-five">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-h-four">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-h-one">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-h-six">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-h-three">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-h-two">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-indent">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-italic">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-outdent">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-strikethrough">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-t">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="text-underline">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="textbox">
        <path d="M248,80v96a16,16,0,0,1-16,16H144a8,8,0,0,1-8-8V72a8,8,0,0,1,8-8h88A16,16,0,0,1,248,80ZM120,48V208a8,8,0,0,1-16,0V192H24A16,16,0,0,1,8,176V80A16,16,0,0,1,24,64h80V48a8,8,0,0,1,16,0ZM88,112a8,8,0,0,0-8-8H48a8,8,0,0,0,0,16h8v24a8,8,0,0,0,16,0V120h8A8,8,0,0,0,88,112Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="thermometer-cold">
        <path d="M248.91,77.72l-20,6.49,12.34,17a8,8,0,1,1-12.94,9.4L216,93.61l-12.34,17a8,8,0,0,1-12.94-9.4l12.34-17-20-6.49A8,8,0,0,1,188,62.5L208,69V48a8,8,0,0,1,16,0V69l20-6.49a8,8,0,0,1,4.95,15.22ZM176,192a56,56,0,1,1-88-45.92V40a32,32,0,0,1,64,0V146.08A56,56,0,0,1,176,192ZM136,40a16,16,0,0,0-32,0V80h32Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="thermometer">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="thermometer-hot">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="thermometer-simple">
        <path d="M160,146.08V40a32,32,0,0,0-64,0V146.08a56,56,0,1,0,64,0ZM128,24a16,16,0,0,1,16,16V80H112V40A16,16,0,0,1,128,24Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="thumbs-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="thumbs-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="ticket">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tidal-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tiktok-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="timer">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tipi">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="toilet-paper">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="toolbox">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tooth">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tote">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tote-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="trademark">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="trademark-registered">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="traffic-cone">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="traffic-sign">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="traffic-signal">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="train">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="train-regional">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="train-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tram">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="translate">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="trash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="trash-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tray">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tree-evergreen">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tree">
        <path d="M128,187.88s0,0-.06,0a71.3,71.3,0,0,1-8,4.61V232a8,8,0,0,0,16,0V192.49a71.3,71.3,0,0,1-8-4.61Z" />
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tree-palm">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="tree-structure">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="trend-down">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="trend-up">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="triangle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="trophy">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="truck">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="twitch-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="twitter-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="umbrella">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="umbrella-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="unite">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="unite-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="upload">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="upload-simple">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="usb">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-circle-gear">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-circle-minus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-circle-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-focus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-gear">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-list">
        <path d="M144,80a8,8,0,0,1,8-8h96a8,8,0,0,1,0,16H152A8,8,0,0,1,144,80Zm104,40H152a8,8,0,0,0,0,16h96a8,8,0,0,0,0-16Zm0,48H176a8,8,0,0,0,0,16h72a8,8,0,0,0,0-16ZM109.29,142a48,48,0,1,0-58.58,0c-20.62,8.73-36.87,26.3-42.46,48A8,8,0,0,0,16,200H144a8,8,0,0,0,7.75-10C146.16,168.29,129.91,150.72,109.29,142Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-minus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-plus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-rectangle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="user-switch">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="users">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="users-four">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="users-three">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="van">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="vault">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="vibrate"><rect x="72" y="32" width="112" height="192" rx="24" />
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="video-camera">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="video-camera-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="video">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="vignette">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="vinyl-record">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="virtual-reality">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="virus">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="voicemail">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="volleyball">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wall">
        <path d="M136,92h92a4,4,0,0,0,4-4V56a8,8,0,0,0-8-8H140a4,4,0,0,0-4,4Z" />
        <path d="M184,152h44a4,4,0,0,0,4-4V112a4,4,0,0,0-4-4H184Z" /><rect x="88" y="108" width="80" height="44" />
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wallet">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="warehouse">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="warning-circle">
        <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm-8,56a8,8,0,0,1,16,0v56a8,8,0,0,1-16,0Zm8,104a12,12,0,1,1,12-12A12,12,0,0,1,128,184Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="warning-diamond">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="warning">
        <path d="M236.8,188.09,149.35,36.22h0a24.76,24.76,0,0,0-42.7,0L19.2,188.09a23.51,23.51,0,0,0,0,23.72A24.35,24.35,0,0,0,40.55,224h174.9a24.35,24.35,0,0,0,21.33-12.19A23.51,23.51,0,0,0,236.8,188.09ZM120,104a8,8,0,0,1,16,0v40a8,8,0,0,1-16,0Zm8,88a12,12,0,1,1,12-12A12,12,0,0,1,128,192Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="warning-octagon">
        <path d="M227.31,80.23,175.77,28.69A16.13,16.13,0,0,0,164.45,24H91.55a16.13,16.13,0,0,0-11.32,4.69L28.69,80.23A16.13,16.13,0,0,0,24,91.55v72.9a16.13,16.13,0,0,0,4.69,11.32l51.54,51.54A16.13,16.13,0,0,0,91.55,232h72.9a16.13,16.13,0,0,0,11.32-4.69l51.54-51.54A16.13,16.13,0,0,0,232,164.45V91.55A16.13,16.13,0,0,0,227.31,80.23ZM120,80a8,8,0,0,1,16,0v56a8,8,0,0,1-16,0Zm8,104a12,12,0,1,1,12-12A12,12,0,0,1,128,184Z" />
    </svg>
    <svg viewBox="0 0 256 256" fill="currentColor" id="watch">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wave-sawtooth">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wave-sine">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wave-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wave-triangle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="waveform">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="waves">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="webcam">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="webcam-slash">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="webhooks-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wechat-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wheelchair-motion">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wifi-high">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wifi-low">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wifi-x">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wind">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="windows-logo">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wine">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="wrench">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="x-circle">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="x">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="x-square">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="yin-yang">
    ...
    <svg viewBox="0 0 256 256" fill="currentColor" id="youtube-logo">
